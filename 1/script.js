...
//     vidurkis: 3.8,
//     pomegiai: {
//         1: "kompiuteriniai zaidimai",
//         2: "kazka",
//         3: "kebabai"},
//     salis: "Lietuva",
//     miestas: "Kaunas",
//     rajonas: "Aleksotas",
//     adresas: "Dariaus ir Gireno 25A"
// }

// for (let i in zmogus){
//     if (typeof zmogus[i] == "object"){
//         for (let j in zmogus[i]){
//             console.log("pomegis yra " + zmogus[i][j])
//         }
//     }
//     else{
...
//         for (let d in duomenys[i]){
//             for (let k in duomenys[i][d]){
//                 console.log(`${k}: ${duomenys[i][d][k]}`)
//             }
//         }
//     }
//     else{
